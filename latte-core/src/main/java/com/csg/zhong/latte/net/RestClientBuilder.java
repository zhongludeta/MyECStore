...
/**
 * Created by 王修智 on 2017-07-30-0030.
 */
...
public class RestClientBuilder {
    ...
    public final RestClient build() {
        return new RestClient(mUrl, PARAMS, mIRequest, mISuccess, mIFailure, mIError, mDownloadDir, mExtension, mName, mBody, mLoaderStyle, mContext, mFile);
    }
